...
- `yt-dlp` обновлён до `2026.08.19` и использует Chrome-имитацию запросов для
  актуальной совместимости с YouTube.

### Fixed

- Скачивание YouTube-аудио больше не помечается как успешное в performance-логе,
  если ошибка была корректно обработана и показана пользователю.
